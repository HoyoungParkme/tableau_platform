...
<div data-screen="UI-9" class="report" style="width:1180px;padding:24px;display:flex;gap:20px">
  ...
  <main class="sheet">
    ...
    <div class="sheet-body">
      ...
      <section data-el="13"><span class="lbl">해설</span><p class="prose">해설 문단<sup class="fn">1</sup></p></section>
      <p data-el="14" class="fixed-note">이 리포트는 판매 대시보드 데이터만 씁니다. 왜 안 팔리는지는 여기서 답하지 않습니다. 도매는 공식 집계 기준이며 실 도매 기준과 12,932대 차이가 있습니다. 이 차이는 미주 누계 상세 행 기준입니다. 미주 누계는 실 도매 664,269대, 도매(공식) 677,201대입니다.</p>
    </div>
  </main>
</div>
```
...
- 도매 정본이 정해지기 전에는 도매(공식)를 기본으로 쓰고 실 도매와의 차이 12,932대를 고정 문구에 적는다. 이 12,932대는 미주 누계 상세 행 기준이다(실 도매 664,269 대 도매(공식) 677,201, 도매(공식) 대비 1.9%). 같은 파일의 전체 총계 행은 실 도매 1,692,227 대 도매(공식) 1,706,430으로 차이가 14,203대이지만, 총계 행은 상세 행과 범위가 달라 상세 행과 더하지 않고 대조에만 쓴다([[TBL-DOM-001#ThresholdSetting]]).
