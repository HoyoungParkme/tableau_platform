...
<div data-screen="UI-9" class="report" style="width:1180px;padding:24px;display:flex;gap:20px">
  ...
  <main class="sheet">
    ...
    <div class="sheet-body">
      ...
      <section data-el="13"><span class="lbl">해설</span><p class="prose">해설 문단<sup class="fn">1</sup></p></section>
      <p data-el="14" class="fixed-note">이 리포트는 판매 대시보드 데이터만 씁니다. 왜 안 팔리는지는 여기서 답하지 않습니다. 도매는 공식 집계 기준이며 실 도매 기준과 27,135대 차이가 있습니다. 이 차이는 전사 누계 기준이며 미주 누계 차이가 아닙니다. 미주 구간의 실 도매 누계는 실측이 없습니다.</p>
    </div>
  </main>
</div>
```
...
- 도매 정본이 정해지기 전에는 도매(공식)를 기본으로 쓰고 실 도매와의 차이 27,135대를 고정 문구에 적는다. 이 27,135대는 전사 누계 기준이다(실 도매 2,356,496 대 도매(공식) 2,383,631). 미주 구간의 실 도매 누계는 실측이 없으므로 이 차이를 미주 값으로 적지 않는다([[TBL-DOM-001#ThresholdSetting]]).
